...
class Network:
    ...
    def homophily(self, grp, ab_naive=True):
        ...
        if ab_naive:
            ...
            return (self.edge_matrix[color][color] - self.edge_matrix_3[color][color]) / (np.sum(self.edge_matrix, axis=0)[color] - np.sum(self.edge_matrix_3, axis=0)[color]) - grp.size / self.nodes
